...
exports.about = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getdata = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.hasEscalator = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.hasLift = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.hasTravelator = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.lineAbout = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.lineID = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.lineName = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.routeService = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.stationName = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.transfer = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
