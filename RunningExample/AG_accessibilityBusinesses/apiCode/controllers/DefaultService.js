...
exports.getClosed_Moved = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getDecal_Recipient = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getLocation = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getSubminusCategory = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getYear = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
exports.getaccessibilityBusinesses = function(args, res, next) {
	exports.getOperation(args, res, next); 
}
